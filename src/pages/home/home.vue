    ...
    <div class="home-page--carousel">
      <div class="home-page--carousel__user">
        <template v-if="true">
          ...
          <div class="function">
            <div class="tool">
              <i class="iconfont icon-zhaogongju"></i>找工具
            </div>
            <div class="misson">
              <i class="iconfont icon-zhaorenwu"></i>找任务
            </div>
            <div class="master">
              <i class="iconfont icon-zhaozhuanjia"></i>找专家
            </div>
            <div class="pi">
              <i class="iconfont icon-zhaoyanjiuzhe"></i>找研究者
            </div>
          </div>
          <div class="btn">
            <el-button style="width: 105px" @click="toLogin">登录</el-button>
            <el-button style="width: 105px" type="primary" @click="toRegister"
              >注册</el-button
            >
          </div>
        </template>
